...
public enum TpchTable {
  ...
  LINEITEM(Arrays.asList(
      ...
      new Column("l_partkey", String.class),
      new Column("l_suppkey", String.class),
      new Column("l_linenumber", Integer.class),
      new Column("l_quantity", String.class),
      new Column("l_extendedprice", Double.class),
      new Column("l_discount", String.class),
      new Column("l_tax", String.class),
      new Column("l_returnflag", String.class),
      new Column("l_linestatus", String.class),
      new Column("l_shipdate", String.class),
